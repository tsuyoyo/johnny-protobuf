...
class PercussionApiError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PercussionApiError', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pj.sakuchin.percussion.proto'), createEmptyInstance: create)
    ..e<PercussionApiError_ErrorCode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorCode', $pb.PbFieldType.OE, protoName: 'errorCode', defaultOrMaker: PercussionApiError_ErrorCode.UNKNOWN, valueOf: PercussionApiError_ErrorCode.valueOf, enumValues: PercussionApiError_ErrorCode.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message')
    ..hasRequiredFields = false
  ;

  PercussionApiError._() : super();
  factory PercussionApiError({
    PercussionApiError_ErrorCode? errorCode,
    $core.String? message,
  }) {
  ...
  'Will be removed in next major version')
  PercussionApiError copyWith(void Function(PercussionApiError) updates) => super.copyWith((message) => updates(message as PercussionApiError)) as PercussionApiError; // ignore: deprecated_member_use
